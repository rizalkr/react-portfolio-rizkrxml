        ...
        <>
            <div id='projects' className='projects  bg-[#171717] text-white py-10'>
                ...
                <p className='text-center max-w-[1000px] lg:px-6 mx-auto text-[#939191]'>
                    lorem ipsum dolor sit amet, consectetur adipisicing elit. Pariatur, cupiditate! Molestiae placeat architecto nihil obcaecati illum
                    minima incidunt dolores? Officia consectetur optio non totam cum eos soluta ipsa et quod.
                </p>
                ...
                {durum === 2 ? (
                    <div id='text2' className='tab-pane  text-center text-white py-16 max-w-4xl mx-auto lg:p-5 '>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati atque porro quasi dolorum facere tempore maxime nemo quia
                        nulla blanditiis doloribus, dolore, voluptas aspernatur harum facilis cumque magni soluta sapiente.
                    </div>
                ) : null}
                {durum === 3 ? (
                    <div id='text1' className='tab-pane  text-center text-white py-5   lg:p-5'>
